...
CORS(app=app, supports_credentials=True, origins=['https://together-client.netlify.app'], methods=['POST'], allow_headers=['Content-Type'])
server_session = Session(app)
socketio = SocketIO(app, manage_session=False, cors_allowed_origins=['https://together-client.netlify.app'])
...
def add_cors_headers(response):
  response.headers['Access-Control-Allow-Origin'] = 'https://together-client.netlify.app'
